...
function ManageAddress() {
  ...
  const setPrimary = async (addId) => {
    console.log(addId);
    try {
      const response = await axiosInstance.patch("/api/v1/address/setprimary", {
        addressId: addId,
      });
    ...
    <div className="card-cluster p-4">
      <div>
        ...
        >
          <Modal.Header
            closeButton
            style={{ borderBottom: "2px solid var(--light-mint)" }}
          >
            <Modal.Title
              style={{
                fontFamily: "var(--font-elegant-script)",
          ...
          {addressDatas.map((addr) => (
            <div className="card-cluster p-3 mb-3" key={addr._id}>
              ...
              <div style={{ fontFamily: "var(--font-sans)" }}>
                ...
                <p
                  className="mb-1"
                  style={{ color: "var(--text-dark)", lineHeight: "1.6" }}
                >
                  {addr.address_line_1}
                  <br />
