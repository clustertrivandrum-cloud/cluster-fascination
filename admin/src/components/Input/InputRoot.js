...
import { safeDestructure, safeColor, safeBorderRadius, safeBoxShadow } from "assets/theme/utils/defensiveComponents";

export default styled(InputBase)(({ theme, ownerState }) => {
  // Get safe theme with comprehensive fallbacks
  ...
  let borderColor = inputColors.borderColor?.main || inputColors.borderColor || '#d2d6da';
  let boxShadowValue = inputBoxShadow;
  let focusedBorderColor = info.main || '#5e72e4';
